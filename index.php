    ...
    <header class="masthead">
      <div class="container">
        <div class="intro-text">
          <div class="intro-lead-in">Welcome To Online Residence Rental Management Zone!</div>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <?php 
              ...
              ?>
              <br><br><br><br><br>
              <center><iframe width="760" height="415" src="https://www.youtube.com/embed/CVrbkmTw5Ck?si=pOa8H7naLiSRmF0d" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe></center>
          </div>
        </div>
      </div>
      <br><br><br><br><br><br>
